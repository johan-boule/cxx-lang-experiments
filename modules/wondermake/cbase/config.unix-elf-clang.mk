...
wondermake.cpp_flags_out_mode = -o$$@ -E -MD -MF$$@.d -MT$$@ -MP -MJ$$@.compile_commands.json
wondermake.pch_flags_out_mode = -o$$@    -MD -MF$$@.d -MT$$@ -MP -MJ$$@.compile_commands.json
wondermake.cxx_flags_out_mode = -o$$@ -c -MJ$$@.compile_commands.json
wondermake.mxx_flags_out_mode = -o$$@ --precompile -MJ$$@.compile_commands.json
...
wondermake.libs_path := staged-install/lib
...
wondermake.ld_flags[executable]        := -Wl,-rpath-link=staged-install/lib -Wl,-rpath=\$$$$ORIGIN/../lib
...
wondermake.binary_file_pattern[executable] := bin/%
wondermake.binary_file_pattern[shared_lib] := lib/lib%.so
wondermake.binary_file_pattern[loadable_module] := lib/%.so
wondermake.binary_file_pattern[import_lib] := # none
wondermake.binary_file_pattern[static_lib] := lib/lib%.a
